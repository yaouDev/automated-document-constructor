...
\BeforeBeginEnvironment{figure}{\begin{float}[H]}
\AfterEndEnvironment{figure}{\end{float}}
% --- End Image Placement Control ---
...
\fancypagestyle{tocwithfooter}{
    \fancyhf{}
    \fancyfoot[C]{\small Created with yaouDev's \href{https://github.com/yaouDev/automated-document-constructor}{Automated Document Constructor}}
